  ...
  return (
    <div className="flex items-center gap-4">
      <div className="social-button">
        <a href="https://www.instagram.com/rohit_kr2k5/" target='_blank'>
          <button className="relative w-12 h-12 rounded-full group">
            <div className="floater w-full h-full absolute top-0 left-0 bg-violet-400 rounded-full duration-300 group-hover:-top-2 group-hover:shadow-2xl" />
      ...
      <div className="social-button">
        <a href="https://github.com/rohit-2k5?tab=repositories" target='_blank'>
          <button className="relative w-12 h-12 rounded-full group">
      ...
      <div className="social-button">
        <a href="https://www.linkedin.com/in/rohit-sharma-36583729a/" target='_blank'>
          <button className="relative w-12 h-12 rounded-full group">
            <div className="floater w-full h-full absolute top-0 left-0 bg-blue-500 rounded-full duration-300 group-hover:-top-2 group-hover:shadow-2xl" />
      ...
      <div className="social-button">
        <button className="relative w-12 h-12 rounded-full group">
          <div className="floater w-full h-full absolute top-0 left-0 bg-red-400 rounded-full duration-300 group-hover:-top-2 group-hover:shadow-2xl" />
